    ...
    def doBacktest(self):
        ...
        for tax in range(2):
            ...
            if tax == 0: # 세제혜택 X 인 경우 결과값들 입력
                ...
                self.real_portfolio_without_tax_account=self.getRealPortfolioValue(total_portfolio_without_balance_account,self.portfolio_balance_account) # 포트폴리오 가치 추이
                self.portfolio_object.portfolio_account_without_tax_benefit = self.portfolio_object.get_portVariables(self.real_portfolio_without_tax_account, self.input_money_to_portfolio) # 포트폴리오 출력결과 변수
                ...
                # print('포트폴리오 가치 추이(잔액포함X):',total_portfolio_without_balance_account)
                # print('포트폴리오 잔액 추이:',self.portfolio_balance_account)
                self.real_portfolio_account_with_tax_benefit=self.getRealPortfolioValue(total_portfolio_without_balance_account,self.portfolio_balance_account)
                self.portfolio_object.portfolio_account_with_tax_benefit = self.portfolio_object.get_portVariables(self.real_portfolio_account_with_tax_benefit, self.input_money_to_portfolio)
        ...
        # print("*************** 세제혜택X ***************")
        # print()
        # print('포트폴리오 가치 추이(잔액포함0):',self.real_portfolio_without_tax_account)
        # print()
        ...
        # print("*************** 세제혜택0 ***************")
        # print()
        # print('포트폴리오 가치 추이(잔액포함0):',self.real_portfolio_account_with_tax_benefit)
        # print()
        # print('포트폴리오 납입금액 추이:', self.input_money_to_portfolio)
        # print()
