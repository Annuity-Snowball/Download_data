...
# 결과데이터프레임 결측치확인
# check_null = df_2016_1Q_BS[df_2016_1Q_BS['ifrs_CurrentAssets'].isnull() | df_2016_1Q_BS['ifrs_Assets'].isnull() | df_2016_1Q_BS['ifrs_CurrentLiabilities'].isnull() | df_2016_1Q_BS['ifrs_Liabilities'].isnull()].copy()
# print(check_null)
